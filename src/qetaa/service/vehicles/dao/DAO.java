package qetaa.service.vehicles.dao;
...
public class DAO {
	...
	@PersistenceContext(unitName = "QetaaVehiclePU")
	...
	public <T> List<T> getConditionOrderBy(Class<T> klass, String columnName, Object val, String orderColumn) {
		Query q = em.createQuery("SELECT b FROM " + klass.getSimpleName() + " b WHERE b." + columnName + " = :value "
